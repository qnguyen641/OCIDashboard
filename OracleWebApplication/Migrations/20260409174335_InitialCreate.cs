        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClientTenantId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OciTenancyOcid = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ClientTenants_ClientTenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ClientTenantId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ClientTenantId",
                table: "AuditLogs",
                column: "ClientTenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientTenants_CompanyName",
                table: "ClientTenants",
                column: "CompanyName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClientTenants_OciTenancyOcid",
                table: "ClientTenants",
                column: "OciTenancyOcid");
        }
